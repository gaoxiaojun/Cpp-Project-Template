...
apt-get update
apt-get install --no-install-recommends -y build-essential cmake ggcov lcov curl unzip sloccount git git-core jenkins doxygen ttf-dejavu libboost-dev libboost-program-options1.63-dev
